...
// node_modules/intl-tel-input/react/build/IntlTelInputWithUtils.js
...
var attachUtils = (source) => {
  if (!intlTelInput.utils && !intlTelInput.startedLoadingUtilsScript) {
    ...
    return loadCall.then((module) => {
      const utils2 = module == null ? void 0 : module.default;
...
var IntlTelInput = (0, import_react.forwardRef)(function IntlTelInput2({
  ...
  const update = (0, import_react.useCallback)(() => {
    var _a, _b;
    const num = ((_a = itiRef.current) == null ? void 0 : _a.getNumber()) || "";
    const countryIso = ((_b = itiRef.current) == null ? void 0 : _b.getSelectedCountryData().iso2) || "";
    onChangeNumber(num);
  ...
  (0, import_react.useEffect)(() => {
    ...
    return () => {
      var _a;
      (_a = itiRef.current) == null ? void 0 : _a.destroy();
    };
  }, []);
  (0, import_react.useEffect)(() => {
...
//# sourceMappingURL=intl-tel-input_reactWithUtils.js.map
